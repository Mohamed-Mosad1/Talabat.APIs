...
namespace Talabat.Core.Entities.Orders_Aggregate
{
    public class Order : BaseEntity
    {
        ...
        public Order(string buyerEmail, OrderAddress shippingAddress, DeliveryMethod deliveryMethod, ICollection<OrderItems> orderItems, decimal subTotal, string paymentIntentId)
        {
            ...
            SubTotal = subTotal;
            PaymentInstantId = paymentIntentId;
        }
